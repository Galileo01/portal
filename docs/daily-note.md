...
9. bug- 修复发布资源时，可能处于用户未登陆状态--工具栏最右侧 添加User组件
...
11. fix- 样式配置-背景 并不支持渐变，修正按钮和文案中包含“渐变”的部分UI和文字

12. fix- back-top 未展示bug
...
下一步必须马上完成的联调&关键bug修复

- [ ] 出码能力联调

  - server

    - 添加pageConfig参数，在页面未发布的情况下，由客户端上传页面配置
    - post方法
    - 自动删除任务
